    ...
    <>
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          <div className="w-full lg:hidden flex items-center justify-center p-4 lg:py-6 gap-5 flex-wrap lg:flex-nowrap">
            <div className="w-full inline-flex items-center justify-center text-black rounded-md pr-2">
              <input
                type="text"
