      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          <div className="w-full flex items-center justify-center p-4 lg:py-6 gap-5 flex-wrap sm:flex-nowrap">
            ...
            <button
              ...
              className="bg-white text-red-400 lg:ml-auto font-semibold py-2 px-4 rounded-lg transition hover:bg-slate-100 duration-300 text-sm lg:text-base"
            >
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          <div className="w-full flex items-center justify-center p-4 lg:py-6 gap-5 flex-wrap sm:flex-nowrap">
            ...
            <button
              onClick={getFilterdData}
              className="bg-white lg:ml-auto text-red-400 font-semibold py-2 px-4 rounded-lg hover:bg-slate-100 transition duration-300 text-sm lg:text-base"
            >
              Filter Posts Within 15KM
            </button>
          </div>
